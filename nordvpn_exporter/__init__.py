...
def daemonize():
    ...
    for fd in range(3, 1024):
        try:
            ...
            pass
    with open("/var/run/nordvpn_exporter.pid", 'w') as f:
...
def main():
    ...
    print("Starting NordVPN Exporter on http://localhost:8082")
    if results.daemon:
        print("[*] Running background /var/run/nordvpn_exporter.pid")
        daemonize()
